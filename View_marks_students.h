...
namespace SMS {
	...
	/// <summary>
	/// Summary for View_marks_students
	/// </summary>
	public ref class View_marks_students : public System::Windows::Forms::Form
	{
		String^currentstudent;
		Form^back;
	public:
		View_marks_students(void)
		{
			InitializeComponent();
			//
		...
		View_marks_students(Form^obj,String^a)
		{
			back = obj;
			currentstudent = a;
			InitializeComponent();
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->marks->Location = System::Drawing::Point(9, 310);
			...
			this->done->Location = System::Drawing::Point(954, 445);
			this->done->Margin = System::Windows::Forms::Padding(4, 5, 4, 5);
			this->done->Name = L"done";
			this->done->Size = System::Drawing::Size(216, 54);
			this->done->TabIndex = 151;
			this->done->Text = L"Done";
			this->done->UseVisualStyleBackColor = false;
			this->done->Click += gcnew System::EventHandler(this, &View_marks_students::done_Click);
			// 
			// show
			// 
			...
			this->label5->Font = (gcnew System::Drawing::Font(L"Buxton Sketch", 16, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label5->Location = System::Drawing::Point(336, 98);
			...
			this->label4->Font = (gcnew System::Drawing::Font(L"Buxton Sketch", 16, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label4->Location = System::Drawing::Point(29, 98);
			...
			this->ClientSize = System::Drawing::Size(1290, 597);
			...
			this->Name = L"View_marks_students";
			this->Text = L"View_marks_students";
			this->Load += gcnew System::EventHandler(this, &View_marks_students::View_marks_students_Load);
...
#pragma endregion
	private: System::Void View_marks_students_Load(System::Object^  sender, System::EventArgs^  e) {
	}
...
private: System::Void show_Click(System::Object^  sender, System::EventArgs^  e) {
			 ...
			 {
				 string rol1, obt, ttl,test;
				 MarshalString(currentstudent, test);
				 while (!read.eof())
				 {
					 read >> rol1;
					 if (rol1 == test)
